...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/elevaciones_con_mancuernas_frontal_lateral_y_posterior.mp4',
  ARRAY['Mantén el core firme y el pecho alto.', 'Para las elevaciones frontales, levanta las mancuernas hacia el frente hasta la altura de los hombros.', 'Para las elevaciones laterales, eleva los brazos hacia los lados con una ligera flexión de codo.', 'Para las elevaciones posteriores, inclina el torso hacia adelante y eleva los brazos hacia los lados enfocándote en la contracción de la parte superior.']::text[],
  'principiante',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/sentadilla_goblet_variaciones_de_elevacion.mp4',
  ARRAY['Sostén una mancuerna verticalmente pegada al pecho.', 'Para enfocar los glúteos, apoya las puntas de los pies sobre unos discos pequeños y realiza la sentadilla.', 'Para enfocar los cuádriceps, apoya los talones sobre los discos y mantén el torso más erguido durante el descenso.', 'Desciende controladamente y empuja desde los pies para volver a la posición inicial.']::text[],
  'intermedio',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/face_pull_en_polea_alta.mp4',
  ARRAY['Ajusta la polea a la altura del pecho superior o del rostro y utiliza un agarre de cuerda.', 'Tira de la cuerda hacia tus ojos o frente, manteniendo los codos altos y alineados con los hombros.', 'Evita encoger los hombros hacia las orejas para no sobrecargar el elevador de la escápula.', 'Controla la fase excéntrica al extender los brazos de regreso a la posición inicial.']::text[],
  'intermedio',
...
values (
  'L-Sit en el suelo',
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/l-sit_en_el_suelo.mp4',
  ...
  ARRAY['resistencia']::text[]
) on conflict (nombre) do nothing;

insert into public.ejercicios (nombre, url_gif, instrucciones, dificultad, descripcion, finalidad)
values (
  'Jalón al pecho en polea',
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/jalon_al_pecho_en_polea.mp4',
  ARRAY['Siéntate en la máquina de jalón asegurando los muslos firmemente bajo los rodillos de soporte.', 'Para enfocar la espalda alta y el dorsal externo, utiliza un agarre prono ancho.', 'Para un mayor enfoque en el dorsal inferior y los bíceps, utiliza un agarre supino estrecho.', 'Tira de la barra hacia la parte superior del pecho deprimiendo las escápulas, y luego extiende los brazos de manera controlada.']::text[],
  'principiante',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/curl_de_biceps_concentrado.mp4',
  ARRAY['Siéntate en un banco con las piernas separadas, sosteniendo una mancuerna con agarre supino.', 'Apoya la parte posterior de tu brazo (tríceps) firmemente en la parte interna del muslo, o mantén el codo bloqueado al costado del torso sin que se desplace hacia atrás.', 'Flexiona el codo para elevar la mancuerna hacia el hombro, contrayendo fuertemente el bíceps.', 'Desciende la mancuerna de manera controlada hasta la extensión casi completa del brazo.']::text[],
  'principiante',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/flexion_y_extension_de_munecas_sentado.mp4',
  ARRAY['Siéntate frente a un banco y apoya completamente tus antebrazos sobre la almohadilla, dejando las muñecas colgando en el borde.', 'Para trabajar los flexores, agarra los discos con las palmas hacia arriba (supinación) y flexiona las muñecas hacia ti.', 'Para trabajar los extensores, agarra los discos con las palmas hacia abajo (pronación) y levanta el dorso de las manos hacia arriba.', 'Mantén el movimiento lento y controlado, evitando usar el impulso o levantar los codos del banco.']::text[],
  'principiante',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/sentadilla_pesada_con_mancuerna_variaciones_de_enfoque.mp4',
  ARRAY['Sostén una mancuerna de manera vertical (estilo goblet) con ambas manos.', 'Para enfatizar los cuádriceps, usa una postura al ancho de los hombros y desciende manteniendo el torso lo más vertical posible.', 'Para enfatizar los glúteos, inclina ligeramente el torso hacia adelante durante el descenso para aumentar la flexión de la cadera.', 'Para enfatizar la parte interna del muslo, separa las piernas más allá del ancho de los hombros (postura sumo) con las puntas de los pies orientadas hacia afuera antes de descender.']::text[],
  'intermedio',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/rutina_de_core_en_suelo_crunches_y_elevaciones_de_rodillas.mp4',
  ARRAY['Acuéstate boca arriba sobre una esterilla con las manos detrás de la cabeza.', 'Realiza flexiones laterales acercando el codo a la rodilla contraria alternadamente.', 'Para la segunda variante, levanta las rodillas hacia el pecho manteniendo la zona lumbar firmemente presionada contra el suelo.', 'Controla la respiración exhalando en la fase concéntrica y desciende de manera controlada.']::text[],
  'principiante',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/curl_de_biceps_sentado_con_mancuerna.mp4',
  ARRAY['Siéntate en un banco con la espalda recta y sujeta una mancuerna con agarre supino.', 'Mantén el codo pegado al torso y alineado verticalmente; evita adelantarlo o balancearlo para no involucrar el deltoides anterior.', 'Flexiona el codo para elevar la mancuerna contrayendo el bíceps en la parte superior.', 'Desciende el peso de forma controlada hasta alcanzar la extensión casi completa del codo.']::text[],
  'principiante',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/extension_de_triceps_tumbado_rompecraneos.mp4',
  ARRAY['Túmbate en un banco plano sosteniendo el peso sobre tu pecho con los brazos casi totalmente extendidos.', 'Flexiona los codos para llevar el peso hacia tu frente o ligeramente por encima de la cabeza.', 'Mantén los codos paralelos y apuntando hacia arriba; no permitas que se abran hacia los lados.', 'Extiende los codos para volver a la posición inicial, apretando el tríceps al máximo en la parte alta.']::text[],
  'intermedio',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/curl_invertido_con_barra.mp4',
  ARRAY['Ponte de pie sosteniendo una barra con un agarre prono a la anchura de los hombros.', 'Mantén los codos firmemente pegados a los costados y asegúrate de mantener las muñecas en posición neutra (rectas).', 'Flexiona los codos para elevar la barra hacia la parte superior del pecho.', 'Baja la barra de manera controlada, asegurándote de no quebrar las muñecas durante la fase excéntrica.']::text[],
  'intermedio',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/flexion_de_brazo_a_una_mano_one-arm_pushup.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/press_de_banca_con_barra.mp4',
  ARRAY['Acuéstate sobre un banco plano con los pies anclados al suelo, retrayendo las escápulas y manteniendo un ligero arco lumbar.', 'Sujeta la barra con un agarre ligeramente más ancho que los hombros y sácala de los soportes.', 'Baja la barra hacia la parte inferior del esternón, manteniendo los codos en un ángulo de aproximadamente 45 a 60 grados respecto al torso.', 'Empuja la barra de regreso hacia la posición inicial, describiendo una ligera curva hacia la línea de los hombros.']::text[],
  'intermedio',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/circuito_de_tren_superior_con_peso_libre.mp4',
  ARRAY['Curl Martillo: Realiza flexión de codos con agarre neutro para trabajar el braquiorradial.', 'Pullover: Tumbado, lleva la mancuerna desde el pecho por encima de la cabeza y regresa, enfocándote en la expansión torácica y el dorsal.', 'Patada de tríceps: Con el torso flexionado hacia adelante, extiende los codos hacia atrás de forma estricta.', 'Elevaciones laterales: Abduce los brazos lateralmente hasta los 90 grados para estimular la porción medial del deltoides.', 'Remo con barra: Con el torso a 45 grados y espalda recta, retrae las escápulas tirando de la barra hacia el abdomen.']::text[],
  'intermedio',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/press_de_hombros_en_maquina_smith.mp4',
  ARRAY['Siéntate en un banco con respaldo a unos 75-85 grados debajo de la barra de la máquina Smith.', 'Sujeta la barra y asegúrate de que los antebrazos queden perfectamente verticales a lo largo del recorrido.', 'No abras los codos a 90 grados; mételos levemente hacia adelante en el plano escapular.', 'Desciende la barra controladamente hasta la altura de la barbilla o clavículas, y empuja hacia arriba sin hiper-extender los codos.']::text[],
  'principiante',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/sentadilla_en_maquina_smith_con_pies_adelantados.mp4',
  ARRAY['Coloca la barra de la máquina Smith sobre la parte posterior de tus hombros (trapecios) y sujétala con ambas manos.', 'Da un pequeño paso hacia adelante, de manera que tus pies queden ligeramente por delante de la línea vertical de la barra. Esta es la clave del ejercicio.', 'Desciende de forma controlada flexionando las rodillas y caderas como si fueras a sentarte en una silla.', 'Asegúrate de que tus rodillas sigan la línea de tus pies y mantén el torso lo más erguido posible.', 'Empuja a través de los talones para volver a la posición inicial, contrayendo fuertemente los glúteos en la parte superior del movimiento.']::text[],
  'intermedio',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/sentadilla_sissy_asistida.mp4',
  ARRAY['Colócate de pie, separando las piernas al ancho de los hombros, y sujétate de un soporte firme con una o ambas manos para mantener el equilibrio.', 'Mantén el torso y los muslos alineados en una línea recta contrayendo fuertemente los glúteos y el core.', 'Desciende flexionando las rodillas hacia adelante mientras tus talones se elevan del suelo y tu cuerpo se inclina hacia atrás.', 'Baja hasta que sientas un estiramiento profundo en los cuádriceps o hasta tu límite de movilidad.', 'Empuja a través de la punta de los pies, extendiendo las rodillas para regresar a la posición inicial.']::text[],
  'avanzado',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/estiramiento_dinamico_lumbar_rodillas_al_pecho_alternadas.mp4',
  ARRAY['Acuéstate boca arriba (decúbito supino) sobre una superficie cómoda, con las piernas extendidas.', 'Flexiona una rodilla y llévala hacia tu pecho, sujetándola con ambas manos por debajo de la rótula (sobre la espinilla).', 'Tira suavemente de la rodilla para aumentar el estiramiento en la zona lumbar y el glúteo de ese lado.', 'Mantén la pierna contraria lo más extendida y pegada al suelo posible para estirar también el flexor de la cadera opuesta.', 'Alterna el movimiento con la otra pierna de manera controlada.']::text[],
  'principiante',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/flexion_de_brazo_push-up_-_tecnica_y_correccion.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/press_de_hombros_con_mancuernas.mp4',
  ARRAY['Siéntate en un banco con respaldo y sostén una mancuerna en cada mano a la altura de los hombros.', 'Alinea los codos ligeramente hacia adelante (aprox. 30 grados en el plano escapular), evitando abrirlos completamente a 180 grados.', 'Empuja las mancuernas hacia arriba de forma controlada hasta que los brazos estén extendidos.', 'Desciende lentamente hasta la posición inicial.']::text[],
  'intermedio',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/circuito_de_movilidad_y_correccion_postural.mp4',
  ARRAY['Realiza pasadas de hombro con un palo o banda (dislocaciones) de adelante hacia atrás para abrir la caja torácica.', 'Apoya la espalda plana contra la pared y desliza los brazos hacia arriba y abajo formando una ''W'' (ángeles de pared).', 'Adopta una posición de zancada con la rodilla apoyada, contrae el abdomen y el glúteo, y avanza ligeramente para estirar el flexor de la cadera.', 'Acuéstate boca arriba y eleva la cadera contrayendo los glúteos (puente de glúteos tradicional y a una pierna).']::text[],
  'principiante',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/curl_de_biceps_con_barra.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/sentadilla_con_barra.mp4',
...
values (
  'Flexiones de brazos',
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/flexiones_de_brazos.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/elevaciones_de_deltoides_con_mancuernas.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/circuito_integral_de_core_y_abdomen.mp4',
  ARRAY['Abdomen total: Realiza encogimientos sentados (seated crunches), apoyando las manos atrás y llevando las rodillas al pecho.', 'Abdomen superior: Acuéstate boca arriba y realiza abdominales de elevación completa con las piernas rectas (straight leg sit-up).', 'Abdomen inferior: Con la espalda baja presionada contra el suelo, ejecuta elevaciones de piernas juntas (leg raises) y aleteos (flutter kicks).', 'Core: En posición de plancha invertida o cuadrupedia (bear hold), realiza patadas hacia atrás (kickbacks) seguidas de escaladores (mountain climbers).']::text[],
  'principiante',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/rutina_de_estiramiento_correctivo_5_minutos.mp4',
  ARRAY['Realiza ejercicios de movilidad torácica con banda o palo (dislocaciones de hombro) para abrir la caja torácica.', 'Ejecuta ángeles en la pared para fortalecer la musculatura estabilizadora de la escápula.', 'Realiza estiramientos de los flexores de la cadera en posición de zancada (rodilla apoyada).', 'Completa con variantes de puente de glúteo para activar la cadena posterior.']::text[],
  'principiante',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/variaciones_biomecanicas_en_remo_sentado.mp4',
  ARRAY['Utiliza un agarre estrecho (V-bar) para un mayor énfasis en el dorsal ancho mediante un rango de movimiento más profundo.', 'Emplea una barra recta (agarre prono) para activar con mayor intensidad la musculatura de la espalda alta (romboides, deltoides posterior).', 'Mantén el torso erguido y retrasa las escápulas al traccionar.', 'Controla la fase excéntrica evitando que los hombros se proyecten hacia adelante.']::text[],
  'intermedio',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/curl_de_biceps_optimizacion_de_la_ejecucion.mp4',
  ARRAY['Sujeta una barra (EZ o recta) con agarre supino.', 'Mantén los codos fijos a ambos lados del torso durante todo el movimiento.', 'Flexiona los codos concentrando el esfuerzo en los bíceps.', 'Evita el uso de inercia o balanceo del cuerpo para elevar la carga.']::text[],
  'principiante',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/variaciones_tecnicas_en_sentadilla_con_smith_machine.mp4',
  ARRAY['Pies adelantados: aumenta la flexión de cadera, enfatizando el trabajo en glúteos e isquiotibiales.', 'Pies alineados con el centro de gravedad: aumenta la flexión de rodilla, priorizando el trabajo en cuádriceps.', 'Postura abierta con rotación externa: incrementa la activación de los aductores (parte interna del muslo).', 'Mantén la columna en posición neutra durante todo el rango de movimiento.']::text[],
  'intermedio',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/sentadilla_con_barra.mp4',
  ARRAY['Apoya la barra sobre los trapecios (no sobre las vértebras cervicales).', 'Inicia el descenso flexionando rodillas y caderas, manteniendo la espalda recta.', 'Desciende hasta que los muslos estén paralelos al suelo (o según la capacidad de movilidad).', 'Regresa a la posición de inicio empujando desde toda la planta del pie.']::text[],
  'avanzado',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/variaciones_en_prensa_de_piernas.mp4',
  ARRAY['Colocación alta en la plataforma: reduce la flexión de rodilla y aumenta la de cadera, favoreciendo el trabajo de glúteos e isquiotibiales.', 'Colocación baja en la plataforma: aumenta la flexión de rodilla, enfatizando el trabajo en cuádriceps.', 'Controla el descenso de la plataforma sin que la zona lumbar se despegue del respaldo.', 'Empuja la plataforma sin bloquear completamente las rodillas en la parte superior.']::text[],
  'intermedio',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/circuito_de_ejercicios_abdominales.mp4',
  ARRAY['Realiza encogimientos sentados para trabajar la musculatura global del abdomen.', 'Ejecuta abdominales de elevación completa (sit-ups) con piernas estiradas para el abdomen superior.', 'Realiza elevaciones de piernas y aleteos (flutter kicks) para enfocar el abdomen inferior.', 'Incorpora escaladores (mountain climbers) para desafiar el core y la estabilidad.']::text[],
  'principiante',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/variaciones_en_elevaciones_laterales_con_mancuernas.mp4',
  ARRAY['Elevaciones frontales: brazos al frente para el deltoides anterior.', 'Elevaciones laterales sentado: apertura lateral para el deltoides medio.', 'Elevaciones sentado inclinado (pájaros): torso inclinado hacia adelante para el deltoides posterior.', 'Controla el movimiento en ambas fases y evita el uso de impulso.']::text[],
  'intermedio',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/variaciones_de_peso_muerto_rumano_vs_piernas_rigidas.mp4',
  ARRAY['Peso muerto rumano: mantén rodillas ligeramente flexionadas (15-20 grados) para enfatizar el trabajo en glúteos.', 'Peso muerto piernas rígidas: mantén rodillas casi bloqueadas (microflexión) para maximizar el estiramiento en isquiotibiales.', 'Mantén la barra siempre pegada a las piernas durante el movimiento.', 'Garantiza que la columna se mantenga en posición neutra durante todo el ejercicio.']::text[],
  'intermedio',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/zancadas_con_mancuernas.mp4',
  ARRAY['Ponte de pie sujetando una mancuerna en cada mano con los brazos relajados a los costados.', 'Da un paso hacia adelante con una pierna, manteniendo el torso erguido o con una ligera inclinación natural hacia adelante.', 'Flexiona ambas rodillas para descender las caderas de forma vertical, hasta que la rodilla trasera casi toque el suelo.', 'Asegúrate de que la rodilla delantera esté estable y empuja firmemente con ese pie para regresar a la posición inicial.']::text[],
  'intermedio',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/extension_toracica_pasiva.mp4',
  ARRAY['Coloca una almohada o cojín en el suelo o sobre tu cama.', 'Acuéstate boca arriba de manera que la almohada soporte la transición entre tu zona lumbar y la espalda alta.', 'Junta las plantas de los pies y deja caer las rodillas hacia los lados (posición de mariposa).', 'Extiende los brazos estirados por encima de la cabeza y respira profundamente, manteniendo la posición de 5 a 10 minutos.']::text[],
  'principiante',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/remo_sentado_en_polea.mp4',
  ARRAY['Ponte de pie frente a una máquina de polea baja y sujeta una barra recta con ambas manos.', 'Flexiona ligeramente las rodillas e inclina el torso hacia adelante desde las caderas, manteniendo la espalda completamente recta y el core activado.', 'Tira de la barra hacia tu abdomen llevando los codos hacia atrás y retrayendo las escápulas.', 'Extiende los brazos de forma controlada hasta la posición inicial sin dejar que la columna se encorve o los hombros colapsen.']::text[],
  'intermedio',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/curl_de_biceps_con_mancuernas_alterno_vs_simultaneo.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/parada_de_antebrazos_forearm_stand.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/traccion_facial_con_cuerda_face_pull.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/circuito_de_gluteos_con_banda_de_resistencia.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/exercisedb/estandar/elevacion_de_gemelos_en_maquina_hack.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/exercisedb/estandar/prensa_de_piernas_a_45.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/exercisedb/estandar/elevacion_frontal_con_mancuernas.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/exercisedb/estandar/curl_de_muneca_inverso_con_mancuernas_sobre_banco.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/exercisedb/estandar/curl_martillo_en_banco_scott_a_una_mano.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/exercisedb/estandar/sentadilla_pistol_con_pesa_rusa.mp4',
...
values (
  'Fondos en paralelas',
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/exercisedb/estandar/fondos_imposibles.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/exercisedb/estandar/flexion_lateral_con_lastre_sobre_fitball.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/exercisedb/estandar/remo_al_menton_a_una_mano_con_mancuerna.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/exercisedb/estandar/elevacion_de_gemelos_de_pie_con_barra.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/exercisedb/estandar/torsion_de_tronco_tumbado_con_rodillas_flexionadas.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/exercisedb/estandar/jalon_frontal_en_maquina_convergente.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/exercisedb/estandar/curl_de_concentracion_de_pie_con_mancuerna.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/exercisedb/estandar/prensa_vertical_en_maquina_smith.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/exercisedb/estandar/elevacion_de_rodillas_colgado_con_impulso_excentrico.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/exercisedb/estandar/hiperextension_lumbar_con_lastre_en_fitball.mp4',
...
values (
  'Crunch en polea',
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/exercisedb/estandar/encogimientos_abdominales_en_polea_crunch_en_polea.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/gym_workout/estandar/dominadas_con_agarre_prono.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/gym_workout/estandar/empuje_de_cadera_con_barra_hip_thrust.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/demic/estandar/sentadilla_con_barra_sentadilla_trasera.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/gym_workout/estandar/aperturas_en_maquina_contractora_peck_deck.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/gym_workout/estandar/elevacion_de_piernas_colgado_en_barra.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/gym_workout/estandar/plancha_abdominal_isometrica.mp4',
  ...
  'intermedio',
  'Ejercicio para abdomen. Zona: cintura. Equipo: peso corporal.',
  ARRAY['isometrico']::text[]
) on conflict (nombre) do nothing;

insert into public.ejercicios (nombre, url_gif, instrucciones, dificultad, descripcion, finalidad)
values (
  'Torsión rusa en suelo',
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/gym_workout/estandar/torsion_rusa_en_suelo.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/gym_workout/estandar/remo_en_barra_t_con_apoyo_pectoral.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/gym_workout/estandar/extension_de_triceps_en_polea_alta.mp4',
...
values (
  'Fondos de tríceps',
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/gym_workout/estandar/fondos_de_triceps.mp4',
  ARRAY[]::text[],
  'intermedio',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/gym_workout/estandar/press_de_banca_plano_con_barra.mp4',
  ARRAY['Paso 1: Acuéstate en un banco plano realizando retracción escapular y apoyando firmemente la planta de ambos pies en el suelo para generar una base estable.', 'Paso 2: Sujeta la barra con agarre prono a una anchura ligeramente superior a la de los hombros y descárgala del soporte con los brazos extendidos.', 'Paso 3: Desciende la barra controladamente hacia la parte inferior del esternón, manteniendo los codos en un ángulo de aproximadamente 45 grados respecto al torso.', 'Paso 4: Impulsa la barra verticalmente mediante una contracción potente del pectoral mayor y el tríceps braquial, exhalando durante la fase concéntrica.', 'Paso 5: Extiende los brazos sin llegar al bloqueo articular completo para preservar la tensión muscular en los pectorales.', 'Paso 6: Repite el movimiento manteniendo la posición escapular estable y el puente torácico durante toda la serie.']::text[],
  'intermedio',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/gym_workout/estandar/press_de_banca_declinado_con_barra.mp4',
  ARRAY['Paso 1: Fija los tobillos en los soportes del banco declinado y acuéstate con la cabeza situada en la parte más baja de la plataforma.', 'Paso 2: Sujeta la barra con agarre prono a una anchura ligeramente superior a los hombros y descárgala del soporte con los brazos extendidos.', 'Paso 3: Desciende la barra controladamente hacia la porción inferior del esternón, enfatizando el trabajo de las fibras esternales e inferiores del pectoral mayor.', 'Paso 4: Impulsa la barra verticalmente contrayendo la porción inferior del pecho y los tríceps braquiales, manteniendo las escápulas retraídas contra el banco.', 'Paso 5: Evita el bloqueo completo de los codos en la posición superior para mantener la tensión mecánica constante en el músculo objetivo.', 'Paso 6: Repite con un ritmo controlado, prestando especial atención a la fase excéntrica para maximizar el estímulo hipertrófico.']::text[],
  'intermedio',
  'Ejercicio para pectorales. Zona: pecho. Equipo: barra.',
  ARRAY['fuerza']::text[]
) on conflict (nombre) do nothing;
...
values (
  'Burpees',
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/synaptixfit/estandar/burpees.mp4',
  ...
  ARRAY['cardio', 'fuerza']::text[]
) on conflict (nombre) do nothing;

insert into public.ejercicios (nombre, url_gif, instrucciones, dificultad, descripcion, finalidad)
values (
  'Saltos de tijera',
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/synaptixfit/estandar/saltos_de_tijera.mp4',
...
values (
  'Escaladores',
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/cardio/estandar/mountain_climbers.mp4',
  ...
  ARRAY['cardio', 'resistencia']::text[]
) on conflict (nombre) do nothing;

insert into public.ejercicios (nombre, url_gif, instrucciones, dificultad, descripcion, finalidad)
values (
  'Rodillas al pecho',
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/synaptixfit/estandar/rodillas_al_pecho.mp4',
...
values (
  'Salto de comba',
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/synaptixfit/estandar/salto_de_comba.mp4',
...
values (
  ...
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/synaptixfit/estandar/sentadillas_con_salto.mp4',
...
values (
  'Salto al cajon',
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/synaptixfit/estandar/salto_al_cajon.mp4',
...
values (
  'Boxeo de sombra',
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/synaptixfit/estandar/boxeo_de_sombra.mp4',
...
values (
  'Zancadas con salto',
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/synaptixfit/estandar/zancadas_con_salto.mp4',
...
values (
  'Tijeras abdominales',
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/synaptixfit/estandar/tijeras_abdominales.mp4',
...
values (
  'Esprints en cinta',
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/cardio/estandar/sprints_en_cinta.mp4',
...
values (
  'Caminata en cinta',
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/synaptixfit/estandar/caminata_en_cinta.mp4',
...
values (
  'Carrera en cinta',
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/synaptixfit/estandar/carrera_en_cinta.mp4',
...
values (
  'Escaladora',
  'https://pub-150303d1abd547199a65ccac4b8fe45b.r2.dev/ejercicios/synaptixfit/estandar/escaladora.mp4',
