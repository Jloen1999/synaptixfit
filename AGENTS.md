...
- **`app/lib/shared/models/db_models.dart`** — all DB model classes (~2515 lines, incl. `CargaAcademicaSemanalDb`, `AsignaturaUsuarioSemestreDb`, `EjercicioDb` con `valorMet`, `SeleccionEjercicioDb` con `duracionObjetivoSegundos`/`duracionRealSegundos`)
