...
class SVShapes {
  ...
  static const BorderRadius standard12 = BorderRadius.all(Radius.circular(radiusStandard12));

  // 16px — tarjetas grandes, modales
  static const double radiusLarge16 = 16.0;
  static const BorderRadius large16 = BorderRadius.all(Radius.circular(radiusLarge16));
  ...
  static const BorderRadius huge = BorderRadius.all(Radius.circular(radiusHuge));
